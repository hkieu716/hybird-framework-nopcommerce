...
public class Level_02_Apply_BasePage_II{ 
  ...
  public void TC_02_Register_Invalid_Email() {
	  ...
	  basePage.sendkeyToElement(driver, "//input[@id='FirstName']", "Kieu");
	  basePage.sendkeyToElement(driver, "//input[@id='LastName']", "Huyen");
	  basePage.sendkeyToElement(driver, "//input[@id='Email']", "123@456#.com");
